...
const STATIC_ROUTES = [
  ...
  { url: '/web-stories/the-story-of-apple',        priority: 0.7, changeFrequency: 'monthly' },
  { url: '/web-stories/the-story-of-microsoft',    priority: 0.7, changeFrequency: 'monthly' },
  { url: '/web-stories/the-story-of-tesla',        priority: 0.7, changeFrequency: 'monthly' },
  { url: '/web-stories/the-story-of-amazon',       priority: 0.7, changeFrequency: 'monthly' },
  { url: '/web-stories/the-story-of-mcdonalds',    priority: 0.7, changeFrequency: 'monthly' },
  { url: '/web-stories/the-story-of-petrobras',    priority: 0.7, changeFrequency: 'monthly' },
  { url: '/web-stories/the-story-of-vale',         priority: 0.7, changeFrequency: 'monthly' },
  ...
  { url: '/web-stories/what-if-1000-alphabet',       priority: 0.7, changeFrequency: 'monthly' },
  { url: '/web-stories/what-if-1000-amazon-stock',   priority: 0.7, changeFrequency: 'monthly' },
  { url: '/web-stories/what-if-1000-meta',           priority: 0.7, changeFrequency: 'monthly' },
  { url: '/web-stories/what-if-1000-broadcom',       priority: 0.7, changeFrequency: 'monthly' },
  { url: '/web-stories/what-if-1000-tesla-stock',    priority: 0.7, changeFrequency: 'monthly' },
  { url: '/web-stories/what-if-1000-jpmorgan',       priority: 0.7, changeFrequency: 'monthly' },
  { url: '/web-stories/what-if-1000-visa',           priority: 0.7, changeFrequency: 'monthly' },
  { url: '/web-stories/what-if-1000-walmart',        priority: 0.7, changeFrequency: 'monthly' },
  { url: '/web-stories/what-if-1000-johnson-johnson', priority: 0.7, changeFrequency: 'monthly' },
  { url: '/web-stories/what-if-1000-exxonmobil',     priority: 0.7, changeFrequency: 'monthly' },
  { url: '/web-stories/what-if-1000-ethereum-crypto', priority: 0.7, changeFrequency: 'monthly' },
  { url: '/web-stories/what-if-1000-xrp',            priority: 0.7, changeFrequency: 'monthly' },
  { url: '/web-stories/what-if-1000-bnb',            priority: 0.7, changeFrequency: 'monthly' },
  { url: '/web-stories/what-if-1000-solana',         priority: 0.7, changeFrequency: 'monthly' },
  { url: '/web-stories/what-if-1000-dogecoin',       priority: 0.7, changeFrequency: 'monthly' },
  { url: '/web-stories/what-if-1000-cardano',        priority: 0.7, changeFrequency: 'monthly' },
  { url: '/web-stories/what-if-1000-tron',           priority: 0.7, changeFrequency: 'monthly' },
  { url: '/web-stories/what-if-1000-chainlink',      priority: 0.7, changeFrequency: 'monthly' },
  { url: '/web-stories/what-if-1000-avalanche',      priority: 0.7, changeFrequency: 'monthly' },
  { url: '/web-stories/what-if-1000-litecoin',       priority: 0.7, changeFrequency: 'monthly' },
  { url: '/web-stories/what-if-1000-polkadot',       priority: 0.7, changeFrequency: 'monthly' },
  { url: '/web-stories/what-if-1000-bitcoin-cash',   priority: 0.7, changeFrequency: 'monthly' },
